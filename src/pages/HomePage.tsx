  ...
  const handleSearch = async (query: string) => {
    try {
      const res = await axios.get<CompanySearch[]>(
        `https://financialmodelingprep.com/api/v3/search?query=${query}&limit=10&exchange=NASDAQ&apikey=qke9LztjQlyLMJZyVYQl0gLcnDtMAbEd`
      );
    ...
    <div>
      ...
      {isAnalyzing && (
        <AlertDialog open={true}>
          <AlertDialogContent>
            <AlertDialogHeader>
              <AlertDialogTitle>Analyzing stock...</AlertDialogTitle>
              <AlertDialogDescription>
                <span
                  role="status"
